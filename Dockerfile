...
# Build noodle workspace using an absolute path
RUN yarn --cwd ./noodle install && yarn --cwd ./noodle build

# Build unicorn workspace using an absolute path
RUN yarn --cwd ./unicorn install && yarn --cwd ./unicorn build
